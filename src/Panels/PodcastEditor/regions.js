                    ...
                    _createClass(Region, [{
                        ...
                        value: function render() {
                            ...
                            if (this.resize) {
                                ...
                                var centreCircle = document.createElement('div');
                                centreCircle.style.position='absolute';
                                centreCircle.style.background='#fff';
                                centreCircle.style.width='2px';
                                centreCircle.style.height='12px';
                                centreCircle.style.alignSelf='center';


                                handleLeft.appendChild(Object.assign(centreCircle));
                                handleRight.appendChild(Object.assign(centreCircle));
